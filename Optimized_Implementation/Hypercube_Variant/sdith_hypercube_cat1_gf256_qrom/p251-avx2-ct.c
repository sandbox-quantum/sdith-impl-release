...
EXPORT void p251_vec_mat16cols_muladd_avx2_ct(void *vz, uint8_t const *vx,
...
/// Performs "z[16] += vx[m] * my[m][16]"
/// parallelizaion over m
EXPORT void p251_vec_mat16cols_muladd_b16_avx2_ct(void *vz, uint8_t const *vx,
                                                  void const *my, uint64_t m) {
  __m128i const *const myy = (__m128i const *)my;
  __m128i *const vzz = (__m128i *)vz;
...
EXPORT void p251_vec_mat128cols_muladd_avx2_ct(void *vz, uint8_t const *vx,
                                               void const *my, uint64_t m) {
  __m128i const *const myy = (__m128i const *)my;
  __m128i *const vzz = (__m128i *)vz;
